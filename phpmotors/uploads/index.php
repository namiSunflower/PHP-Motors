...
//Collects the "action" value from the "post" or "get" options of the "request" from the browser
...
switch ($action) {
    ...
    case 'delete':
        ...
        if ($remove) {
        $message = "<p class='red'>$filename was successfully deleted.</p>";
        } else {
        $message = "<p class='red'>$filename was NOT deleted.</p>";
        }
